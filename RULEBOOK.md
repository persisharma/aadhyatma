...
## 23. Shubh Yoga (PRD-27) — the additive-vocabulary rule-table contract

The शुभ योग tables (`mobile/src/panchang/shubhYoga.ts`; design.md §67, §33, §60) name what is specially right about a day from the shipped panchang primitives. They are **religious content** and carry the same obligations as the §17 occasion tables, plus the annotate-only hard lines below.
