...
- Sharing boundaries: Gochar has **no share card**; report sections and the report summary share only through the warned Kundali path (birth details named in the warning), never through the Rashifal no-birth-details path.
