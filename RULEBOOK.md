...
11. **Verification.** `npm run test:ask` (tsx) + `components/__tests__/AskAnswerCard.test.tsx` (Jest) + the three `.maestro/ask-*-smoke.yaml` flows; typecheck and `npm run lint` at 0 errors; design.md §70 updated in the same PR.
