...
- One closing line, the privacy fact only (`खाता निजी है — केवल इस डिवाइस पर।`), since the ledger door no longer carries a subtitle. **No stance line** — see the copy rule below.
