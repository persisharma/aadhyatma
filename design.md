...
shape produces (this picker lost its seventh column on 375 dp phones). The header month-year is a button that opens an overlay of month chips + a scrollable
