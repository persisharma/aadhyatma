...
**दान-कथा (`screens/DaanKathaScreen.tsx`).** Story paragraphs 14/25 `ink-soft` via `commentaryByLang`, the `शिक्षा` panel (`goldChipBg`, gold uppercase label, `saffron-deep` teaching + serif-italic English), the rendered canonical source line, ॥ ॐ ॥ endcap.
