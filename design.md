...
**Known Phase-1 limits (PRD-16).** Rule tables are DRAFT pending §10 review (RULEBOOK §17 — release gate); Bhadra is the sunrise karana, not a window; angas are evaluated at sunrise, not at the candidate window. Following an **occasion** as a standing interest ("tell me when a श्रेष्ठ day appears") remains out of scope — this slice follows *days*.
