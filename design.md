...
**Regional coverage of the observance catalog** (Sept 2026 — the “Goga Navami is missing” audit). The catalog is **176 rules, 164 of them default-visible**; the rest are `advanced`/`regional` and reachable only through catalog search. Two rules about what goes where:
...
**Section A additions (29 rules, Sept 2026)** — found by a sweep of the standard pan-Hindu festival list (Drik, the Sri Mandir calendar) after a user asked why वराह जयंती was missing. All universal, all plain lunar-tithi rules, no engine work. Vishnu's avatars — मत्स्य (Chaitra S3), कूर्म (Vaishakha S15), वराह (Bhadrapada S3), वामन (Bhadrapada S12), कल्कि (Shravana S6), हयग्रीव (Shravana S15) जयंती, and हलषष्ठी · ललही छठ (Bhadrapada K6, Balarama's day). Saints — सूरदास and आदि शंकराचार्य (both Vaishakha S5), तुलसीदास (Shravana S7, links to the Ramcharitmanas reader), वाल्मीकि (Ashvina S15, links to the Valmiki Ramayan reader), वल्लभाचार्य (Vaishakha K11), कबीर (Jyeshtha S15). Devi and sampradaya days — बगलामुखी, छिन्नमस्ता, धूमावती, अन्नपूर्णा, नर्मदा, जानकी जयंती, महेश नवमी, फुलेरा दूज. Named days — नरक चतुर्दशी (now a card of its own, not only the दीपावली arc's gap label), काल भैरव जयंती, मौनी अमावस्या, गणेश जयंती (`madhyahna`), भीष्म अष्टमी (`madhyahna`), माघ पूर्णिमा, and both गुप्त नवरात्रि openings (Ashadha, Magha). **Varaha, Matsya, Kalki and Hayagriva carry `dayRule: 'aparahna'`**, because Drik fixes these days by an afternoon puja window. That matters in 2026 for two of them: Varaha is 13 Sep, not the sunrise 14th, and Hayagriva is 27 Aug, a day before Raksha Bandhan on the same Purnima. Each rule is pinned to a published date and to the sibling rule that shares its tithi (`observanceDates.test.ts`, SECTION_A_*). The default year grows from 308 to 337 rows, about 0.08 more observances a day. **Held back:** ललिता पंचमी (2025 published a day before the sunrise Panchami), शारदीय दुर्गा अष्टमी / महानवमी (published sources split 18/19 and 19/20 Oct 2026), वैकुंठ चतुर्दशी (nishita-vyapini, not modelled), बलराम जयंती (three dates across three traditions), गायत्री and रामानुज जयंती (contested tithi), and सर्वपितृ अमावस्या (already on the calendar through Pitru Paksha).
