...
## 67. जिज्ञासा — Ask Vedansh: answer-first search, आज का विधान, answers that act (PRD-25)
...
**Files.** `mobile/src/ask/{types,fold,aliases,lexicon,resolve,engine,useAsk,actions,briefing}.ts` · `mobile/src/ask/intents/index.ts` · `components/AskAnswerCard.tsx` · `screens/{SearchScreen,TodayVidhanScreen,ObservanceDetailScreen,HomeScreen}.tsx` · `navigation/{types,HomeStackNavigator}.tsx`. Tests: `src/ask/__tests__/{fold,lexicon,resolve,corpus,briefing,launchPath}.test.ts` (tsx, `npm run test:ask`; the golden corpus gates ≥ 85% top-1 and zero wrong answers — 199/199 at ship), `components/__tests__/AskAnswerCard.test.tsx` (Jest); device paths `.maestro/ask-answer-smoke.yaml`, `ask-abstain-smoke.yaml`, `ask-briefing-smoke.yaml`. See RULEBOOK §23, `docs/roadmap/prds/25-jijnasa-ask-vedansh.md`, and the clickable prototype `docs/jijnasa-ask-prototype.html`.
