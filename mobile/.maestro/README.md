...
| `ashtakam-smoke.yaml` | Ashtakam. Home → Ashtakam tile → CategoryList (Sankat Mochan Hanuman Ashtak + Lingashtakam) → Lingashtakam reader → language toggle (title becomes "Lingashtakam") → back. PRD-A entries use the multi-instance AshtakamReader; the pre-existing Hanuman Ashtak keeps its dedicated reader. |
