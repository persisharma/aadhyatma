...
| `regional-calendar-lens-smoke.yaml` | **PRD-42 Wave 2 calendar lenses.** Panchang → Vrat & Parv → the approved `क्षेत्र · Calendars` ledger row → grouped Regional calendars sheet; normalizes Jain off, proves off → on through the checkbox accessibility state and updated ledger summary, then restores Jain off. Date-independent because Wave 2 intentionally has zero lensed dates; presentation-date behavior is pinned across engine, Ask, widget and notification suites. Authored 2026-09-06; iOS and Android device runs owed. |
