...
| `ask-briefing-smoke.yaml` | **आज का विधान briefing** (PRD-31 Phase 2). Search empty state → "Open Today's Vidhan" → header, first answer card composes (30 s budget for the astronomy), "Ask something else" → Search, Back → briefing, Back → Home (a Home-stack push, not a tab hijack). Authored 2026-09-02; not yet run on a simulator. |
