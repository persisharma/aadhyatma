...
| `granth-smoke.yaml` | Granth: 5 sections (Bhagavad Gītā, Sundarkand, Ramcharitmanas, Valmiki Ramayan, Upanishads). Verifies all 7 Valmiki kāṇḍas and opens Uttara Kāṇḍa; then the 3-row Upanishads index and the Kena reader (śānti page → `Mantra · 1.1`). |
