...
| `granth-smoke.yaml` | Granth: 5 sections (Bhagavad Gītā, Sundarkand, Ramcharitmanas, Valmiki Ramayan, Upanishads). Verifies all 7 Valmiki kāṇḍas and opens Uttara Kāṇḍa; then the 108-row Upanishads catalogue (readable rows + dimmed coming rows, Group filter chips) and the Kena reader (śānti page → `Mantra · 1.1`). |
