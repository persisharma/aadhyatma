...
export const ramChalisaVerses: readonly RamChalisaVerse[] =
  data.verses as RamChalisaVerse[];
...
(function assertRamChalisaInvariants() {
  if (ramChalisaVerses.length !== 43) {
    throw new Error(`ram-chalisa: expected 43 verses, got ${ramChalisaVerses.length}`);
  }
