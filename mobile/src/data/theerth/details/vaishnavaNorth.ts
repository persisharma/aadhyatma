...
export const details: Record<string, TempleDetail> = {
  'banke-bihari': {
    ...
    sources: [
      source('Shri Banke Bihari Mandir — Mandir History', 'https://www.bihariji.org/public/MandirHistory.aspx'),
      source('District Mathura, Government of Uttar Pradesh — Shri Banke Bihari', 'https://mathura.nic.in/tourist-place/shri-banke-bihari/'),
      source('Banke Bihari Temple — Reference', 'https://en.wikipedia.org/wiki/Banke_Bihari_Temple'),
    ],
    sections: [
      {
        id: 'sthapana',
  ...
  srinathji: {
    ...
    sources: [
      source('Shrinathji Temple, Nathdwara — Official', 'https://www.nathdwaratemple.org/'),
      source('Rajasthan Tourism — Rajsamand', 'https://www.tourism.rajasthan.gov.in/rajsamand.html'),
      source('Shrinathji Temple — Reference', 'https://en.wikipedia.org/wiki/Shrinathji_Temple'),
    ],
    sections: [
      {
        id: 'sthapana',
  ...
  'vishnupad-gaya': {
    ...
    sources: [
      source('Bihar Tourism — Vishnupad Temple, Gaya', 'https://tourism.bihar.gov.in/en/destinations/gaya/vishnupad-temple'),
      source('District Gaya Ji, Government of Bihar — Places of Interest', 'https://gaya.nic.in/places-of-interest/'),
      source('Vishnupad Temple, Gaya — Reference', 'https://en.wikipedia.org/wiki/Vishnupad_Temple'),
    ],
    sections: [
      {
        id: 'sthapana',
  ...
  'lakshmi-narayan': {
    ...
    sources: [
      source('Delhi Tourism, Government of NCT of Delhi — Birla Mandir', 'https://delhitourism.gov.in/tourist_place/birla_mandir.html'),
      source('Laxminarayan Temple — Reference', 'https://en.wikipedia.org/wiki/Laxminarayan_Temple'),
    ],
    sections: [
      {
        id: 'sthapana',
