 ...
 *
 * All four temples of this chunk are authored: padmanabhaswamy, udupi-krishna,
 * bhadrachalam, manakula-vinayagar.
 */
...
export const details: Record<string, TempleDetail> = {
  padmanabhaswamy: {
    ...
    sources: [
      source("Sree Padmanabhaswamy Temple Trust", "https://spstt.org/"),
      source(
      ...
      source(
        "Incredible India (Ministry of Tourism) - Sree Padmanabhaswamy Temple",
        "https://www.incredibleindia.gov.in/en/kerala/thiruvananthapuram/sree-padmanabhaswamy-temple",
      ),
      source(
        "Padmanabhaswamy Temple - Reference",
  ...
  "udupi-krishna": {
    ...
    sources: [
      source(
        "Karnataka Tourism - Udupi Sri Krishna Temple",
        "https://karnatakatourism.org/tour-item/udupi-sri-krishna-temple/",
      ),
      source(
        "Karnataka Tourism - Udupi Paryaya Festival",
        "https://karnatakatourism.org/en/events/udupi-paryaya-festival",
      ),
      source(
        "Udupi Sri Krishna Matha - Reference",
  ...
  bhadrachalam: {
    ...
    sources: [
      source(
        "Sri Sita Ramachandra Swamy Devasthanam, Bhadrachalam (Telangana)",
        "https://bhadradritemple.telangana.gov.in/",
      ),
      source(
        "Sreerama Navami - Utsav (Ministry of Tourism)",
        "https://utsav.gov.in/public/view-event/sreerama-navami",
      ),
      source(
        "Sita Ramachandraswamy Temple, Bhadrachalam - Reference",
  ...
  "manakula-vinayagar": {
    ...
    sources: [
      source(
        ...
        "https://manakulavinayagartemple.com/",
      ),
      source(
        "Incredible India (Ministry of Tourism) - Arulmigu Manakula Vinayagar",
        "https://www.incredibleindia.gov.in/en/puducherry/puducherry/arulmigu-manakula-vinayagar",
      ),
      source(
        "Manakula Vinayagar Temple - Reference",
