...
export const DAAN_PRINCIPLE_ENTRIES: readonly DaanPrincipleEntry[] = [
  ...
  },
  {
    ...
    source: {
      ...
      verificationNote:
        '2026-09-01: DRAFT — the daśa-dāna enumeration is regionally split (source lists disagree on 2–3 items); needs a second concordant source naming one list, or ships with the variance stated. Invisible until then (RULEBOOK §25 draft rule).',
