...
const data = readContent<typeof import('./krishna-chalisa.json')>('krishna-chalisa/krishna-chalisa.json');
...
export const krishnaChalisaVerses: readonly KrishnaChalisaVerse[] =
  data.verses as KrishnaChalisaVerse[];
