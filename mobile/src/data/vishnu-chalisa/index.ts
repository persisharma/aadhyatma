...
export const vishnuChalisaVerses: readonly VishnuChalisaVerse[] = data.verses as VishnuChalisaVerse[];
...
(function assertVishnuChalisaInvariants() {
  if (vishnuChalisaVerses.length !== 42) {
    throw new Error(`vishnu-chalisa: expected 42 verses, got ${vishnuChalisaVerses.length}`);
  }
