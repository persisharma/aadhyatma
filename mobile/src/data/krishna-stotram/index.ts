...
const ch01 = readContent<typeof import('./chapter-01.json')>('krishna-stotram/chapter-01.json');
const ch02 = readContent<typeof import('./chapter-02.json')>('krishna-stotram/chapter-02.json');
