...
const ch01 = readContent<typeof import('./chapter-01.json')>('durga-stotram/chapter-01.json');
const ch02 = readContent<typeof import('./chapter-02.json')>('durga-stotram/chapter-02.json');
const ch03 = readContent<typeof import('./chapter-03.json')>('durga-stotram/chapter-03.json');
