export const SUPPORT_EMAIL = 'vedansh.app.support@gmail.com';
...
export const helpContent: { hi: HelpCopy; en: HelpCopy } = {
  hi: {
    ...
    disclaimerParagraphs: [
      ...
      'समस्त सामग्री व्यक्तिगत अध्ययन एवं भक्ति हेतु उचित प्रयोग (Fair Use) तथा अव्यावसायिक उद्देश्य से प्रस्तुत है। यदि किसी सामग्री के प्रयोग में आपको आपत्ति हो अथवा आपके अधिकारों का उल्लंघन प्रतीत हो, तो कृपया vedansh.app.support@gmail.com पर सम्पर्क करें ताकि शीघ्र समीक्षा एवं सुधार किया जा सके।',
  ...
  en: {
    ...
    disclaimerParagraphs: [
      ...
      'All material is presented under a fair-use, non-commercial framework for personal study and devotion. If you believe content has been used incorrectly or violates your rights, please write to vedansh.app.support@gmail.com so we can review and correct it promptly.',
