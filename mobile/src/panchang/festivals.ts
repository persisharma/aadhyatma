...
export const FESTIVAL_RULES: ObservanceRule[] = [
  ...
  // Bhadrapada Shukla Dwadashi — Vamana Jayanti, the appearance of Vishnu's fifth
  // (Vamana) avatar; the day sits between Parivartini Ekadashi and Anant Chaturdashi
  // and was the last unnamed Dashavatara jayanti in the catalog (the generic
  // `dwadashi-vrat-shukla` was all this day carried). Published: 23 Sep 2026 — Drik
  // "Vamana Jayanti", and BhaktiBharat with the same Dwadashi tithi window (22 Sep
  // 21:45 → 23 Sep 22:52 IST). Drik fixes the puja to MADHYAHNA with Shravana
  // nakshatra, so the rule selects the midday-prevailing Dwadashi, not the udaya one.
  festival({ id: 'vamana-jayanti', nameHi: 'वामन जयंती', nameEn: 'Vamana Jayanti', lunarMonth: 6, paksha: 'shukla', tithi: 12, dayRule: 'madhyahna', marker: 'star', deityHi: 'भगवान वामन', deityEn: 'Bhagwan Vamana', shortDescriptionHi: 'भाद्रपद शुक्ल द्वादशी को वामन जयंती — भगवान विष्णु के पाँचवें अवतार वामन का प्राकट्य दिवस। राजा बलि से तीन पग भूमि माँगकर त्रिविक्रम रूप धारण करने की कथा इसी दिन स्मरण की जाती है; पूजा मध्याह्न काल में श्रवण नक्षत्र के योग में की जाती है।', shortDescriptionEn: 'Vamana Jayanti on Bhadrapada Shukla Dwadashi — the appearance day of Vamana, the fifth avatar of Bhagwan Vishnu. The story of the three paces of land asked of King Bali and the Trivikrama form is remembered on this day, and the puja is held in the madhyahna (midday) period under Shravana nakshatra.', searchTerms: ['vamana jayanti', 'vaman jayanti', 'vamana dwadashi', 'vaman dwadashi', 'vamana avatar', 'trivikrama', 'raja bali', 'dashavatara'], sourceUrl: 'https://www.drikpanchang.com/dashavatara/vamana/vamana-jayanti-date-time.html' }),
