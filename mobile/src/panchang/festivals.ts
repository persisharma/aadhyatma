...
export const FESTIVAL_RULES: ObservanceRule[] = [
  ...
  festival({ id: 'maha-shivaratri', nameHi: 'महा शिवरात्रि', nameEn: 'Maha Shivaratri', lunarMonth: 12, paksha: 'krishna', tithi: 14, marker: 'star', deityHi: 'भगवान शिव', deityEn: 'Lord Shiva', linkSectionId: 'shiv-chalisa', kathaId: 'maha-shivaratri-vrat-katha', vidhiId: 'maha-shivaratri-puja', upvasId: 'maha-shivaratri-upvas' }),
  ...
  festival({ id: 'janmashtami', nameHi: 'जन्माष्टमी', nameEn: 'Janmashtami', lunarMonth: 6, paksha: 'krishna', tithi: 8, marker: 'star', deityHi: 'श्री कृष्ण', deityEn: 'Shri Krishna', linkSectionId: 'bhagavad-gita', kathaId: 'janmashtami-katha', upvasId: 'janmashtami-upvas' }),
  ...
  festival({ id: 'ganesh-chaturthi', nameHi: 'गणेश चतुर्थी', nameEn: 'Ganesh Chaturthi', lunarMonth: 6, paksha: 'shukla', tithi: 4, marker: 'star', deityHi: 'श्री गणेश', deityEn: 'Shri Ganesh', linkSectionId: 'ganesh-chalisa', kathaId: 'ganesha-chaturthi-vrat-katha', vidhiId: 'ganesh-chaturthi-sthapana' }),
  ...
  festival({ id: 'navratri-start', nameHi: 'नवरात्रि प्रारंभ', nameEn: 'Navratri Begins', lunarMonth: 7, paksha: 'shukla', tithi: 1, marker: 'star', deityHi: 'मां दुर्गा', deityEn: 'Maa Durga', linkSectionId: 'durga-stotram', kathaId: 'navratri-start-katha', vidhiId: 'navratri-ghatasthapana' }),
  ...
  festival({ id: 'karwa-chauth', nameHi: 'करवा चौथ', nameEn: 'Karwa Chauth', lunarMonth: 8, paksha: 'krishna', tithi: 4, marker: 'star', category: 'vrat', deityHi: 'मां गौरी', deityEn: 'Maa Gauri', kathaId: 'karwa-chauth-vrat-katha', vidhiId: 'karwa-chauth-puja', upvasId: 'karwa-chauth-upvas' }),
  ...
  festival({ id: 'diwali', nameHi: 'दीपावली', nameEn: 'Diwali', lunarMonth: 8, paksha: 'krishna', tithi: 15, marker: 'star', deityHi: 'मां लक्ष्मी', deityEn: 'Maa Lakshmi', kathaId: 'diwali-legends', vidhiId: 'diwali-lakshmi-ganesh-puja' }),
...
export const MONTHLY_VRAT_RULES: ObservanceRule[] = [
  vrat({ id: 'sankashti-chaturthi-vrat', nameHi: 'संकष्टी चतुर्थी व्रत', nameEn: 'Sankashti Chaturthi Vrat', recurrence: 'monthly', paksha: 'krishna', tithi: 4, deityHi: 'श्री गणेश', deityEn: 'Shri Ganesh', linkSectionId: 'ganesh-chalisa', kathaId: 'sankashti-chaturthi-vrat-katha', upvasId: 'sankashti-chaturthi-upvas' }),
  ...
  vrat({ id: 'pradosh-vrat-shukla', nameHi: 'शुक्ल प्रदोष व्रत', nameEn: 'Shukla Pradosh Vrat', recurrence: 'monthly', paksha: 'shukla', tithi: 13, deityHi: 'भगवान शिव', deityEn: 'Lord Shiva', linkSectionId: 'shiv-chalisa', kathaId: 'pradosha-vrat-katha', upvasId: 'pradosh-upvas' }),
  vrat({ id: 'pradosh-vrat-krishna', nameHi: 'कृष्ण प्रदोष व्रत', nameEn: 'Krishna Pradosh Vrat', recurrence: 'monthly', paksha: 'krishna', tithi: 13, deityHi: 'भगवान शिव', deityEn: 'Lord Shiva', linkSectionId: 'shiv-chalisa', kathaId: 'pradosha-vrat-katha', upvasId: 'pradosh-upvas' }),
  ...
  vrat({ id: 'masik-shivaratri', nameHi: 'मासिक शिवरात्रि', nameEn: 'Masik Shivaratri', recurrence: 'monthly', paksha: 'krishna', tithi: 14, deityHi: 'भगवान शिव', deityEn: 'Lord Shiva', linkSectionId: 'shiv-chalisa', kathaId: 'maha-shivaratri-vrat-katha', upvasId: 'maha-shivaratri-upvas' }),
  upavas({ id: 'purnima-vrat', nameHi: 'पूर्णिमा व्रत', nameEn: 'Purnima Vrat', recurrence: 'monthly', paksha: 'shukla', tithi: 15, deityHi: 'श्री विष्णु', deityEn: 'Shri Vishnu', kathaId: 'satyanarayana-vrat-katha', vidhiId: 'satyanarayan-puja', upvasId: 'purnima-satyanarayan-upvas' }),
  vrat({ id: 'shree-satyanarayan-vrat', nameHi: 'श्री सत्यनारायण व्रत', nameEn: 'Shree Satyanarayan Vrat', recurrence: 'monthly', paksha: 'shukla', tithi: 15, deityHi: 'श्री सत्यनारायण', deityEn: 'Shree Satyanarayan', linkSectionId: 'vishnu-sahasranama', kathaId: 'satyanarayana-vrat-katha', vidhiId: 'satyanarayan-puja', upvasId: 'purnima-satyanarayan-upvas' }),
  ...
  vrat({ id: 'masik-krishna-janmashtami', nameHi: 'मासिक कृष्ण जन्माष्टमी', nameEn: 'Masik Krishna Janmashtami', recurrence: 'monthly', paksha: 'krishna', tithi: 8, deityHi: 'श्री कृष्ण', deityEn: 'Shri Krishna', linkSectionId: 'bhagavad-gita', kathaId: 'masik-krishna-janmashtami-katha', upvasId: 'janmashtami-upvas' }),
