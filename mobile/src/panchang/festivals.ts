...
export const KATHA_CATALOG: KathaCatalogEntry[] = [
  ...
  katha({ id: 'ganesh-jayanti-katha', nameHi: 'गणेश जयंती व्रत कथा', nameEn: 'Ganesh Jayanti Vrat Katha', sourceUrl: 'https://www.drikpanchang.com/hindu-gods/ganesha/ganesha-jayanti/ganesha-jayanti-date-time.html', relatedRuleIds: ['ganesh-jayanti'] }),
  katha({ id: 'narak-chaturdashi-katha', nameHi: 'नरक चतुर्दशी कथा', nameEn: 'Narak Chaturdashi Katha', kind: 'festival-legend', sourceUrl: 'https://www.drikpanchang.com/festivals/abhyangsnan/festivals-abhyangsnan-timings.html', relatedRuleIds: ['narak-chaturdashi'] }),
  katha({ id: 'mauni-amavasya-katha', nameHi: 'मौनी अमावस्या कथा', nameEn: 'Mauni Amavasya Katha', kind: 'mahatmya', sourceUrl: 'https://www.drikpanchang.com/amavasya/maghi/mauni-amavasya-date-time.html', relatedRuleIds: ['mauni-amavasya'] }),
  katha({ id: 'varaha-jayanti-katha', nameHi: 'वराह जयंती कथा', nameEn: 'Varaha Jayanti Katha', kind: 'festival-legend', sourceUrl: 'https://www.drikpanchang.com/dashavatara/varaha/varaha-jayanti-date-time.html', relatedRuleIds: ['varaha-jayanti'] }),
  katha({ id: 'vamana-jayanti-katha', nameHi: 'वामन जयंती कथा', nameEn: 'Vamana Jayanti Katha', kind: 'festival-legend', sourceUrl: 'https://www.drikpanchang.com/dashavatara/vamana/vamana-jayanti-date-time.html', relatedRuleIds: ['vamana-jayanti'] }),
  ...
  katha({ id: 'masik-kalashtami-katha', nameHi: 'मासिक कालाष्टमी कथा', nameEn: 'Masik Kalashtami Katha', kind: 'vrat-katha', sourceUrl: 'https://www.drikpanchang.com/vrat-katha/vrat-katha.html', relatedRuleIds: ['masik-kalashtami', 'kaal-bhairav-jayanti'] }),
...
export const FESTIVAL_RULES: ObservanceRule[] = [
  ...
  festival({ id: 'vamana-jayanti', nameHi: 'वामन जयंती', nameEn: 'Vamana Jayanti', lunarMonth: 6, paksha: 'shukla', tithi: 12, marker: 'dot', kathaId: 'vamana-jayanti-katha', bhogId: 'vamana-jayanti-bhog', deityHi: 'भगवान वामन', deityEn: 'Lord Vamana', shortDescriptionHi: 'भाद्रपद शुक्ल द्वादशी को भगवान विष्णु के पांचवें अवतार, वामन भगवान की जयंती — जिन्होंने राजा बलि से तीन पग भूमि मांगकर तीनों लोक नाप लिए। श्रवण नक्षत्र के साथ पड़ने पर इसका विशेष महत्त्व है; केरल में यही कथा ओणम की है।', shortDescriptionEn: 'The jayanti of Lord Vamana, Vishnu’s fifth avatar, on Bhadrapada Shukla Dwadashi — who asked King Bali for three paces of land and measured the three worlds. It is held especially sacred when it falls with Shravana nakshatra; in Kerala the same story is Onam’s.', searchTerms: ['vamana jayanti', 'vaman jayanti', 'vamana dwadashi', 'vamana avatar', 'dashavatar', 'raja bali', 'trivikrama'] }),
  ...
  festival({ id: 'ganesh-jayanti', nameHi: 'गणेश जयंती', nameEn: 'Ganesh Jayanti', lunarMonth: 11, paksha: 'shukla', tithi: 4, dayRule: 'madhyahna', marker: 'dot', deityHi: 'श्री गणेश', deityEn: 'Shri Ganesh', linkSectionId: 'ganesh-chalisa', kathaId: 'ganesh-jayanti-katha', bhogId: 'ganesh-jayanti-bhog', shortDescriptionHi: 'माघ शुक्ल चतुर्थी को गणेश जयंती — तिलकुंद या माघी गणेश चतुर्थी, इस परंपरा में श्री गणेश का जन्म दिवस। मध्याह्न में गणेश पूजन, तिल के लड्डू का भोग और व्रत किया जाता है; महाराष्ट्र और कोंकण में यह बड़े उत्सव के रूप में मनाई जाती है। भाद्रपद की गणेश चतुर्थी (स्थापना-विसर्जन वाला गणेशोत्सव) और माघ कृष्ण की सकट चौथ इससे अलग पर्व हैं।', shortDescriptionEn: 'Ganesh Jayanti on Magha Shukla Chaturthi — Tilkund or Maghi Ganesh Chaturthi, Shri Ganesh’s birth day in this reckoning. Ganesha puja at midday, an offering of sesame laddoos and a fast mark it; Maharashtra and the Konkan keep it as a major utsav. Bhadrapada’s Ganesh Chaturthi (the Ganeshotsav of installation and immersion) and Magha Krishna’s Sakat Chauth are separate festivals.', searchTerms: ['ganesh jayanti', 'ganesha jayanti', 'maghi ganesh', 'magha ganesh chaturthi', 'tilkund chaturthi', 'tilkunda chaturthi', 'varad chaturthi'] }),
