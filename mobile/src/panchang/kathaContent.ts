...
export const KATHA_CONTENT: readonly KathaContentEntry[] = [
  ...
  fullContent({
    ...
    sections: [
      {
        id: 'farmer-error',
        titleHi: 'किसान की भूल',
        titleEn: 'The farmer mistake',
        bodyHi: [
          'नाग पंचमी की लोककथा में एक किसान खेत जोतते समय अनजाने में नाग के बच्चों को हानि पहुंचा देता है। नागिन क्रोध और शोक से भर जाती है। जीवन की चोट का उत्तर प्रतिशोध में बदलने लगता है।',
          'कथा में किसान परिवार पर संकट आता है। पर उसकी बेटी या बहू नागों के प्रति श्रद्धा रखती है। वह दूध, हल्दी, फूल और नम्र वाणी से नाग देवता से क्षमा मांगती है।',
        ],
        bodyEn: [
          'A folk story of Nag Panchami tells of a farmer who unknowingly harms the young of a serpent while ploughing the field. The serpent mother is filled with grief and anger. The wound to life begins to turn toward revenge.',
          'Danger comes upon the farmer family. But his daughter or daughter-in-law holds reverence for the nagas. She asks forgiveness from the serpent deities with milk, turmeric, flowers, and humble speech.',
        ],
      },
      {
        id: 'compassion',
        titleHi: 'श्रद्धा से शांत क्रोध',
        titleEn: 'Reverence calms anger',
        bodyHi: [
          'नाग देवता उसकी भक्ति और अहिंसक भावना से प्रसन्न होते हैं। वे परिवार को क्षमा करते हैं और रक्षा का आशीर्वाद देते हैं। कथा में मनुष्य और प्रकृति के बीच संतुलन की बात आती है।',
          'यह प्रसंग बताता है कि खेत, घर और वन में रहने वाले प्राणी केवल भय के विषय नहीं हैं। उनके प्रति सावधानी और आदर भी धर्म का भाग है।',
        ],
        bodyEn: [
          'The serpent deities are pleased by her devotion and non-harming attitude. They forgive the family and bless them with protection. The story speaks of balance between human beings and nature.',
          'The episode teaches that creatures living in field, home, and forest are not only objects of fear. Carefulness and respect toward them are also part of dharma.',
        ],
      },
      {
        id: 'naga-worship',
        titleHi: 'नाग पूजन',
        titleEn: 'Worship of the nagas',
        bodyHi: [
          'नाग पंचमी पर नाग देवता का चित्र, मूर्ति या स्थान पूजित होता है। दूध, लावा, दूर्वा, हल्दी और फूल अर्पित किए जाते हैं। कई परंपराओं में धरती को अनावश्यक न खोदने और सर्पों को न मारने का भाव रखा जाता है।',
          'नाग जल, उर्वरता, पाताल, कुंडलिनी और रक्षा से भी जुड़े हैं। कथा उनके प्रति भय को श्रद्धा और सावधानी में बदलती है।',
        ],
        bodyEn: [
          'On Nag Panchami, an image, form, or sacred place of the naga deities is worshipped. Milk, grains, durva, turmeric, and flowers are offered. Many traditions also keep the discipline of not digging the earth unnecessarily and not killing serpents.',
          'Nagas are associated with water, fertility, the subterranean realm, kundalini, and protection. The katha transforms fear of them into reverence and careful conduct.',
        ],
      },
      {
        id: 'nag-message',
        titleHi: 'प्रकृति के साथ संतुलन',
        titleEn: 'Balance with nature',
        bodyHi: [
          'नाग पंचमी व्रत कथा भक्त को सिखाती है कि मनुष्य का जीवन प्रकृति से अलग नहीं है। खेत की समृद्धि, जल की रक्षा और जीवों के प्रति दया एक ही धर्म के अंग हैं।',
          'नाग पूजन का संदेश है कि शक्ति का सम्मान करो, भय को हिंसा में मत बदलो और भूल होने पर विनम्रता से क्षमा मांगो। ऐसा आचरण ही परिवार और धरती दोनों के लिए मंगलकारी है।',
        ],
        bodyEn: [
          'The Nag Panchami katha teaches that human life is not separate from nature. The prosperity of fields, protection of water, and compassion toward living beings are parts of the same dharma.',
          'The message of naga worship is to respect power, not turn fear into violence, and ask forgiveness with humility when a mistake occurs. Such conduct is auspicious for both family and earth.',
        ],
      },
    ],
  }),
