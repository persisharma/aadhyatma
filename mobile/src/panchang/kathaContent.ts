...
export const KATHA_CONTENT: readonly KathaContentEntry[] = [
  ...
  fullContent({
    ...
    sections: [
      {
        id: 'hunter-in-the-forest',
        titleHi: 'वन में फँसा व्याध',
        titleEn: 'The hunter stranded in the forest',
        bodyHi: [
          'किसी नगर के पास के घने जंगल में लुब्धक नाम का एक व्याध रहता था। उसका जीवन निर्दय शिकार पर ही टिका था — हिरन, खरगोश, पक्षी, जो भी हाथ लगता, उसी से वह अपने भूखे परिवार का पेट भरता। उस दिन भी वह धनुष-बाण लेकर सवेरे ही वन में निकल पड़ा था, पर साँझ ढलने तक उसे एक भी शिकार नहीं मिला। थका-हारा, भूखा और प्यासा लुब्धक खाली हाथ लौटने का साहस नहीं जुटा पा रहा था, क्योंकि घर पर बच्चे राह देख रहे थे।',
          'अंधेरा गहराने लगा तो जंगली पशुओं का भय बढ़ गया। प्राण बचाने के लिए लुब्धक पास के एक तालाब के किनारे खड़े बेल के वृक्ष पर चढ़ गया और रात भर वहीं टिके रहने का निश्चय किया। उसे यह तनिक भी पता न था कि जिस पेड़ के नीचे बरसों से पत्तों और मिट्टी में ढका एक शिवलिंग छिपा हुआ था, उसी की छाँव में वह आ बैठा है। संयोग से वह रात फाल्गुन मास के कृष्ण पक्ष की चतुर्दशी की रात थी — वही महा शिवरात्रि, जिस रात भगवान शिव की आराधना का अनंत फल कहा गया है।',
        ],
        bodyEn: [
          'In the dense forest beside a certain town lived a hunter named Lubdhaka. His whole livelihood rested upon a merciless trade — deer, hares, birds, whatever fell to his arrows fed his hungry family. That morning too he had set out early with bow and quiver, yet by the time dusk gathered he had not brought down a single creature. Worn out, famished and parched, Lubdhaka could not find the courage to return empty-handed, for his children were waiting at home.',
          'As the darkness thickened, the danger from prowling beasts grew. To save his life, Lubdhaka climbed a bilva tree standing at the edge of a nearby pond and resolved to wait out the night there. He had no inkling that beneath that very tree, hidden for years under fallen leaves and earth, lay a Shiva linga, and that he had taken refuge in its shade. By chance that night was the fourteenth of the dark fortnight of the month of Phalguna — the very Maha Shivaratri, the night on which the worship of Lord Shiva is said to bear endless fruit.',
        ],
      },
      {
        id: 'the-unknowing-vigil',
        titleHi: 'अनजाने में हुआ जागरण',
        titleEn: 'The vigil kept without knowing',
        bodyHi: [
          'रात लंबी और काटनी कठिन थी। नींद न आ जाए और कहीं नीचे गिरकर हिंसक पशुओं का भोजन न बन जाए, इस डर से लुब्धक जागता रहा और मन बहलाने के लिए धीरे-धीरे बेल के पत्ते तोड़कर नीचे फेंकता रहा। एक-एक करके वे कोमल त्रिदल पत्ते टूटकर ठीक उसी छिपे शिवलिंग पर गिरते रहे, मानो अनजाने हाथों से रात भर शिव का अर्चन हो रहा हो। प्यास और थकान से उसकी आँखों से आँसू भी ढुलकते, और उसके शरीर के हिलने से पेड़ की ओस तथा तालाब का जल भी बूँद-बूँद उसी लिंग पर अभिषेक की तरह टपकता रहा।',
          'इस तरह बिना किसी संकल्प के, बिना किसी मंत्र के, केवल भय और भूख से जागते हुए लुब्धक ने पूरी रात उपवास भी रखा और शिवलिंग पर बेलपत्र, जल और अश्रु भी चढ़ाते रहा — वही चार बातें जो शिवरात्रि के व्रत का प्राण हैं: जागरण, उपवास, बेलपत्र और अभिषेक। भोर होते-होते उसका कठोर हृदय भीतर से कोमल पड़ने लगा। जिन प्राणियों को वह नित्य मारता था, उनके लिए पहली बार उसके मन में करुणा जागी, और अनजाने में की गई इस आराधना ने उसके वर्षों के पाप धोने आरंभ कर दिए।',
        ],
        bodyEn: [
          'The night was long and hard to bear. Afraid that sleep might overtake him and that he would tumble down to become a meal for the beasts, Lubdhaka stayed awake, and to pass the hours he kept plucking the bilva leaves and dropping them below. One by one those tender three-lobed leaves fell straight upon the buried Shiva linga, as though unseen hands were worshipping Shiva all through the night. Tears of thirst and exhaustion trickled from his eyes, and with every shift of his body the dew of the tree and the water of the pond dripped drop by drop upon that linga like a sacred bathing.',
          'Thus, with no vow on his lips and no mantra in his mind, kept awake only by fear and hunger, Lubdhaka unknowingly fasted the whole night and offered bilva leaves, water and his own tears upon the linga — the very four things that form the heart of the Shivaratri observance: wakefulness, fasting, bilva leaves and the bathing of the linga. As dawn approached, his hardened heart began to soften from within. For the creatures he killed each day, compassion stirred in him for the first time, and this worship offered without his knowing began to wash away the sins of many years.',
        ],
      },
      {
        id: 'the-grace-of-shiva',
        titleHi: 'शिव की कृपा और मुक्ति',
        titleEn: 'The grace of Shiva and liberation',
        bodyHi: [
          'जिस रात पूरी सृष्टि शिव की आराधना में लीन रहती है, उसी रात भगवान शिव अपने भक्त की एक-एक बूँद श्रद्धा को देख रहे थे। उस अनपढ़ व्याध की अनजान भक्ति से प्रसन्न होकर वे प्रकट हुए और बोले, ‘हे लुब्धक! जिस रात संसार सोता रहा, तू मेरे लिए जागा; जिस लिंग को तू जानता तक न था, उसी पर तूने रात भर पत्र, जल और अश्रु अर्पित किए, और बिना अन्न-जल के व्रत रखा। तेरी यह सहज श्रद्धा किसी विधिवत पूजा से कम नहीं।’',
          'शिव की वाणी सुनते ही लुब्धक का सारा भय और थकान जाती रही, और उसकी आँखों से अब पश्चाताप तथा प्रेम के आँसू बहने लगे। उसने पेड़ से उतरकर शिवलिंग के चरणों में मस्तक रख दिया और हिंसा का जीवन सदा के लिए त्याग दिया। भगवान शंकर ने उसे अभय और भक्ति का वरदान दिया, उसके समस्त पाप क्षमा किए, और अंत समय में उसे अपने धाम का अधिकारी बनाकर जन्म-मरण के बंधन से मुक्त कर दिया। एक निर्दय व्याध केवल एक शिवरात्रि की सच्ची, अनजानी आराधना से शिव का प्रिय भक्त बन गया।',
        ],
        bodyEn: [
          'On the night when all creation is absorbed in the worship of Shiva, the Lord himself was watching every drop of his devotee\'s faith. Pleased by the unlettered hunter\'s unknowing devotion, he appeared before him and said, ‘O Lubdhaka! On the night the world slept, you stayed awake for me; upon a linga you did not even know, you offered leaves, water and tears all night long, and you kept the fast without food or drink. This artless faith of yours is in no way less than worship performed by rule.’',
          'The moment he heard Shiva\'s words, all of Lubdhaka\'s fear and weariness fell away, and now tears of repentance and love streamed from his eyes. He climbed down from the tree, laid his head at the feet of the Shiva linga, and forsook the life of killing forever. Lord Shankara granted him the gift of fearlessness and devotion, forgave him all his sins, and at the end of his days made him worthy of his own abode, freeing him from the bondage of birth and death. A merciless hunter, through one true and unknowing worship on a single Shivaratri, became a beloved devotee of Shiva.',
        ],
      },
      {
        id: 'the-night-of-shiva',
        titleHi: 'शिव की रात्रि और लिंग की महिमा',
        titleEn: 'The night of Shiva and the glory of the linga',
        bodyHi: [
          'तभी से फाल्गुन की वह चतुर्दशी जगत में महा शिवरात्रि के नाम से पूजी जाने लगी, क्योंकि यही वह रात है जब शिव और शक्ति के मंगल मिलन का स्मरण होता है और जब शिव स्वयं अनादि ज्योतिर्लिंग के रूप में प्रकट होकर ब्रह्मा और विष्णु की भी समझ से परे रहे थे। उस अनंत ज्योति-स्तंभ का न आदि मिला, न अंत, और तभी से शिवलिंग की पूजा सबसे श्रेष्ठ मानी गई — वही लिंग जिसे लुब्धक ने अनजाने में बेलपत्र और जल से सींचा था।',
          'इसी से कहा जाता है कि जो भक्त इस रात श्रद्धा से उपवास रखता है, रात भर जागकर शिव का नाम स्मरण करता है, और शिवलिंग पर जल तथा बेलपत्र अर्पित करता है, उसके जाने-अनजाने सारे पाप शिव की कृपा से धुल जाते हैं और अंत में उसे शिवलोक तथा मोक्ष की प्राप्ति होती है। जब एक व्याध की अनजान आराधना इतना फल दे सकती है, तो जो जान-बूझकर प्रेम और भक्ति से यह व्रत करता है, उस पर शिव की असीम करुणा कहाँ नहीं बरसेगी — यही महा शिवरात्रि व्रत की चिरंतन महिमा है।',
        ],
        bodyEn: [
          'From that time, the fourteenth night of Phalguna came to be revered across the world as Maha Shivaratri, for this is the night on which the auspicious union of Shiva and Shakti is remembered, and on which Shiva himself appeared as the beginningless pillar of light whose form lay beyond the grasp of even Brahma and Vishnu. Neither could find the beginning nor the end of that endless column of radiance, and ever since, the worship of the Shiva linga has been held supreme — the very linga that Lubdhaka had unknowingly bathed with bilva leaves and water.',
          'For this reason it is said that the devotee who fasts with faith on this night, who stays awake remembering the name of Shiva, and who offers water and bilva leaves upon the Shiva linga, has all sins — known and unknown — washed away by Shiva\'s grace, and in the end attains the abode of Shiva and liberation. If the unknowing worship of one hunter could yield such fruit, then upon the one who keeps this vow knowingly, with love and devotion, where would Shiva\'s boundless compassion not pour down — this is the everlasting glory of the Maha Shivaratri vrat.',
        ],
      },
    ],
  }),
  ...
  fullContent({
    ...
    sections: [
      {
        id: 'dawn-of-the-imperishable',
        titleHi: 'अक्षय तिथि का उदय',
        titleEn: 'The dawn of the imperishable day',
        bodyHi: [
          'वैशाख मास के शुक्ल पक्ष की तृतीया की भोर थी। आकाश अभी हलका नीला ही हुआ था कि सत्ययुग के ऋषि-मुनि नदी के घाट पर एकत्र होने लगे। पूर्व दिशा में सूर्य की पहली किरण जल पर पड़ी, तो ऐसा जान पड़ा मानो सारी जलराशि स्वर्ण की हो गई हो। बूढ़े नारद इस तेज को देखते हुए बोले, ‘आज का दिन और दिनों जैसा नहीं — आज जो कुछ दिया जाएगा, जो कुछ जपा-तपा जाएगा, वह घटेगा नहीं, क्षय को प्राप्त नहीं होगा। इसी से इसका नाम अक्षय तृतीया है।’',
          'सत्संग में बैठे लोग पूछ बैठे कि ऐसा वरदान इस तिथि को किसने दिया। तब वृद्ध ऋषि ने स्मरण कराया — यही वह पावन तिथि है जिस दिन सत्ययुग का अंत और त्रेतायुग का आरंभ हुआ; यही वह दिन है जिस दिन माँ गंगा स्वर्ग से उतरकर पृथ्वी पर बहीं; और इसी तिथि को भगवान विष्णु ने अपने भक्तों को यह आश्वासन दिया कि इस दिन किया हुआ पुण्य अनंत गुना होकर जन्म-जन्मांतर तक साथ चलता है। यह सुनकर सबके हृदय श्रद्धा से भर उठे, और वे विष्णु का स्मरण करते हुए स्नान-दान में लग गए।',
        ],
        bodyEn: [
          'It was the dawn of the third lunar day of the bright fortnight of Vaishakha. The sky had only just turned pale blue when the sages and seers of the Satya Yuga began to gather upon the river ghat. As the first ray of the sun fell upon the water in the east, it seemed as though the whole expanse of the river had turned to gold. The aged Narada gazed at the radiance and said, ‘This day is unlike other days — whatever is given away upon it, whatever is chanted and meditated upon, shall not dwindle, shall never come to decay. For this very reason it is called Akshaya Tritiya, the imperishable third.’',
          'Those seated in the holy assembly asked who had granted such a boon to this day. Then the elder seer reminded them — this is the sacred date on which the Satya Yuga ended and the Treta Yuga began; this is the day on which Mother Ganga descended from heaven and flowed upon the earth; and it was on this very day that Lord Vishnu gave His devotees the assurance that merit earned upon it grows boundlessly and travels with the soul from birth to birth. Hearing this, every heart filled with reverence, and they turned to bathing and giving in charity while remembering Vishnu.',
        ],
      },
      {
        id: 'dharmadas-the-poor-devotee',
        titleHi: 'धर्मदास नामक निर्धन भक्त',
        titleEn: 'Dharmadas, the poor devotee',
        bodyHi: [
          'उसी काल में एक नगर के छोर पर धर्मदास नाम का एक निर्धन वैश्य रहता था। उसका घर मिट्टी का था, अन्न के भंडार प्रायः खाली रहते, और कई बार तो परिवार को आधे पेट ही सोना पड़ता। फिर भी धर्मदास का मन सदा संतुष्ट और भगवान विष्णु के चरणों में लगा रहता। एक दिन उसने किसी सत्पुरुष के मुख से अक्षय तृतीया की महिमा सुनी — कि इस दिन जल, अन्न और थोड़ा-सा दान भी अक्षय फल देता है। यह सुनकर उसकी आँखें चमक उठीं और उसने मन-ही-मन निश्चय किया कि चाहे जो हो, इस बार वह यह व्रत अवश्य करेगा।',
          'तृतीया के दिन धर्मदास प्रातः ही गंगा में स्नान करके आया। उसने अपनी पत्नी से कहा, ‘हमारे पास देने को बहुत नहीं, पर जो है वही प्रेम से दे देंगे; भगवान भाव देखते हैं, भार नहीं।’ उसकी पत्नी ने भी हँसकर सहमति दी। दोनों ने मिलकर एक घड़ा शीतल जल, थोड़े जौ-सत्तू, गुड़, एक पंखा और दो वस्त्र निकाले, उन्हें तुलसीदल से सजाया, और विष्णु का ध्यान करते हुए ब्राह्मणों तथा प्यासे राहगीरों को अपने द्वार पर बुलाकर बड़े आदर से वह सब अर्पित कर दिया। देते समय धर्मदास के मन में न कोई कमी का दुख था, न कोई दिखावे की चाह — केवल यही प्रार्थना थी कि नारायण प्रसन्न हों।',
        ],
        bodyEn: [
          'In that same age, at the edge of a certain town, there lived a poor merchant named Dharmadas. His house was of mud, his grain stores were nearly always empty, and many a time the family had to sleep on a half-filled stomach. Yet Dharmadas’s mind remained ever content and fixed at the feet of Lord Vishnu. One day he heard from the lips of a holy man the glory of Akshaya Tritiya — that on this day even water, grain, and a small gift bear imperishable fruit. Hearing this, his eyes lit up, and he resolved within himself that come what may, this time he would surely keep the vow.',
          'On the day of the third, Dharmadas rose early, bathed in the Ganga, and returned home. He said to his wife, ‘We have little to give, but what we have we shall give with love; the Lord looks upon the feeling, not the weight.’ His wife agreed with a smile. Together they brought out a pot of cool water, a little barley meal, some jaggery, a hand-fan and two pieces of cloth, adorned them with tulsi leaves, and meditating upon Vishnu, called brahmins and thirsty travellers to their door and offered all of it with great respect. As he gave, there was in Dharmadas’s heart neither sorrow at his lack nor any wish to be seen — only the single prayer that Narayana be pleased.',
        ],
      },
      {
        id: 'the-fruit-that-never-fades',
        titleHi: 'कभी न मुरझाने वाला फल',
        titleEn: 'The fruit that never fades',
        bodyHi: [
          'धर्मदास ने यह व्रत किसी एक वर्ष का बंधन समझकर नहीं किया। हर वैशाख की तृतीया लौटती और वह उसी श्रद्धा से, अपनी निर्धनता के बीच भी, जल-दान और अन्न-दान करता रहता; उसका भाव वर्ष-दर-वर्ष और भी निर्मल होता गया। संसार की दृष्टि में वह दरिद्र ही रहा, पर भीतर उसका धर्म-कोष भरता चला गया। समय आने पर उसने यह देह त्यागी, और जो पुण्य उसने इस अक्षय तिथि पर बोया था, वह बीज नष्ट नहीं हुआ — वह उसकी आत्मा के साथ अगले जन्म तक चला गया।',
          'अगले जन्म में वही धर्मदास एक धर्मात्मा, उदार और ऐश्वर्यशाली राजा के रूप में जन्मा। उसके कोष कभी रीते न होते, उसके भंडार सदा भरे रहते, और जितना वह दान देता, उसकी संपदा उतनी ही बढ़ती जाती — मानो लक्ष्मी ने उसके आँगन में स्थायी निवास कर लिया हो। पर इतने वैभव में भी उसका मन न तो अहंकार से फूला, न भोग में डूबा; वह राजा बनकर भी पूर्वजन्म के उसी निर्धन भक्त की भाँति प्रतिवर्ष अक्षय तृतीया का व्रत करता, अन्नदान करता और नारायण का स्मरण करता रहा। इस प्रकार उस एक अक्षय तिथि पर किए हुए छोटे-से दान ने उसे जन्म-जन्मांतर तक न घटने वाली समृद्धि दे दी।',
        ],
        bodyEn: [
          'Dharmadas did not keep this vow as the obligation of a single year. Every Vaishakha the third day would return, and with the same devotion, even amid his poverty, he would go on giving water and grain; his feeling grew purer year upon year. In the eyes of the world he remained poor, but within, his store of dharma kept filling. When his time came he left that body, and the merit he had sown upon this imperishable day was a seed that did not perish — it travelled with his soul into the next birth.',
          'In that next birth the same Dharmadas was born as a righteous, generous and prosperous king. His treasuries were never empty, his storehouses always full, and the more he gave away, the more his wealth increased — as though Lakshmi had taken up permanent residence in his courtyard. Yet even amid such splendour his mind neither swelled with pride nor sank into indulgence; though now a king, he still kept the vow of Akshaya Tritiya each year like the poor devotee of his former life, giving food and remembering Narayana. Thus a small gift made upon that single imperishable day granted him a prosperity that did not diminish from one birth to the next.',
        ],
      },
      {
        id: 'sudama-and-the-akshaya-patra',
        titleHi: 'सुदामा और अक्षयपात्र',
        titleEn: 'Sudama and the inexhaustible vessel',
        bodyHi: [
          'इसी अक्षय तृतीया की महिमा का एक और साक्षी है द्वापर का वह प्रसंग, जब निर्धन ब्राह्मण सुदामा अपने बालसखा श्रीकृष्ण से मिलने द्वारका पहुँचा। उसके पास भेंट में देने को केवल थोड़े-से तंदुल — चावल के पोहे — थे, जिन्हें उसकी पत्नी ने पड़ोस से माँगकर एक पुराने वस्त्र में बाँध दिया था। फटे वस्त्रों में लिपटे सुदामा को देखकर भी श्रीकृष्ण सिंहासन से दौड़ पड़े, उसे हृदय से लगाया, अपने पास बैठाया, और उसके लाए वे मुट्ठीभर पोहे बड़े प्रेम से छीन-छीनकर खाए। सुदामा संकोच में कुछ माँग ही न सका और लौट गया — पर लौटते ही उसने देखा कि उसकी टूटी झोपड़ी के स्थान पर स्वर्ण-महल खड़ा है और घर अक्षय संपदा से भर गया है।',
          'इसी तिथि से वनवास के दिनों का वह स्मरण भी जुड़ा है, जब सूर्यदेव ने युधिष्ठिर को अक्षयपात्र प्रदान किया था। वह ऐसा दिव्य पात्र था जिससे प्रतिदिन तब तक अन्न समाप्त न होता जब तक द्रौपदी स्वयं भोजन न कर लें — जितने अतिथि आएँ, सबके लिए भोजन निकलता ही रहता। निर्धन हो या वनवासी, राजा हो या ब्राह्मण — इन सब कथाओं में एक ही स्वर गूँजता है: इस तिथि पर भगवान जिसे जो देते हैं, वह कभी रीतता नहीं, और भक्त जो थोड़ा-सा भी प्रेम से अर्पित करता है, वह अनंत गुना होकर लौटता है।',
        ],
        bodyEn: [
          'Another witness to the glory of this Akshaya Tritiya is that episode of the Dvapara age, when the poor brahmin Sudama came to Dwaraka to meet his boyhood friend Shri Krishna. He had nothing to bring as a gift but a little parched rice — beaten rice flakes — which his wife had begged from the neighbours and tied up in an old cloth. Even seeing Sudama wrapped in his torn rags, Krishna ran down from His throne, embraced him to His heart, seated him at His side, and ate the handfuls of flattened rice he had brought with great love, snatching at them eagerly. Out of shyness Sudama could ask for nothing and turned for home — but no sooner had he returned than he saw that in place of his broken hut there stood a palace of gold, and his home was filled with imperishable wealth.',
          'Linked to this same day, too, is the memory of the forest years, when the Sun-god granted Yudhishthira the Akshaya Patra. It was a divine vessel from which food would not run out each day until Draupadi herself had eaten — however many guests arrived, food kept coming forth for them all. Poor man or forest-dweller, king or brahmin — through all these tales a single note resounds: whatever the Lord gives upon this day never runs dry, and whatever a devotee offers, however small, with love, returns to him multiplied without end.',
        ],
      },
      {
        id: 'the-vow-that-endures',
        titleHi: 'अक्षय रहने वाला व्रत',
        titleEn: 'The vow that endures',
        bodyHi: [
          'इन्हीं कथाओं को स्मरण करते हुए आज भी अक्षय तृतीया के दिन भक्त ब्रह्ममुहूर्त में उठते हैं, पवित्र नदी या जल में स्नान करते हैं, और भगवान विष्णु तथा माता लक्ष्मी का पूजन करते हैं। कोई जल से भरा घड़ा, छाता या पंखा दान करता है, कोई जौ, चना, गुड़ और अन्न निर्धनों को बाँटता है, तो कोई तुलसीदल चढ़ाकर भगवान का जप करता है। धन की मात्रा से कुछ नहीं होता — जो भी श्रद्धा और प्रेम से अर्पित किया जाए, वही इस तिथि पर अक्षय हो जाता है।',
          'कहते हैं, जो मनुष्य इस पावन तिथि को सच्चे मन से व्रत, स्नान, जप और दान करता है, उसके घर से दरिद्रता दूर हो जाती है, उसकी संपदा और सुख कभी क्षीण नहीं होते, और अंत में वह नारायण के परम धाम को प्राप्त करता है। धर्मदास की भाँति आज भी असंख्य भक्त इसी विश्वास से इस तिथि की प्रतीक्षा करते हैं — कि इस दिन बोया हुआ धर्म का एक छोटा-सा बीज जन्म-जन्मांतर तक फलता रहेगा और कभी मुरझाएगा नहीं। यही अक्षय तृतीया की अक्षय महिमा है।',
        ],
        bodyEn: [
          'Remembering these very tales, even today on the day of Akshaya Tritiya devotees rise in the hour before dawn, bathe in a sacred river or pure water, and worship Lord Vishnu and Mother Lakshmi. One gives away a pot filled with water, an umbrella or a fan; another distributes barley, gram, jaggery and grain among the poor; yet another offers tulsi leaves and chants the Lord’s name. The amount of wealth matters nothing — whatever is offered with reverence and love becomes imperishable upon this day.',
          'It is said that the one who keeps the vow, bathes, chants and gives in charity with a true heart upon this sacred date sees poverty driven from his home, finds that his wealth and happiness never wane, and at the last attains the supreme abode of Narayana. Like Dharmadas, countless devotees still await this day with that same faith — that a single small seed of dharma sown upon it will go on bearing fruit from birth to birth and will never wither. This is the imperishable glory of Akshaya Tritiya.',
        ],
      },
    ],
  }),
