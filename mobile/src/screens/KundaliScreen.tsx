...
const styles = StyleSheet.create({
  ...
  caption: { fontFamily: fontFamilies.inter, fontSize: 10, lineHeight: 14 },
  ...
  lagnaLabel: { fontFamily: fontFamilies.interSemiBold, fontSize: 10, letterSpacing: 1 },
  lagnaValue: { fontFamily: fontFamilies.latinSemiBold, fontSize: 14, marginTop: 2 },
  lagnaTranslation: { fontFamily: fontFamilies.inter, fontSize: 10, marginTop: 1 },
  ...
  resultTabText: { fontFamily: fontFamilies.interSemiBold, fontSize: 10 },
  ...
  tablePrimary: { fontFamily: fontFamilies.interSemiBold, fontSize: 12 },
  tableTranslation: { fontFamily: fontFamilies.inter, fontSize: 10 },
  eyebrowText: { fontFamily: fontFamilies.interSemiBold, fontSize: 10, letterSpacing: 1.3 },
  ...
  progressCaption: { fontFamily: fontFamilies.inter, fontSize: 10 },
  ...
  antarChipText: { fontFamily: fontFamilies.interSemiBold, fontSize: 10 },
  ...
  nowTagText: { fontFamily: fontFamilies.interSemiBold, fontSize: 10 },
  practiceLabel: { fontSize: 10, marginTop: 18, marginBottom: 8 },
