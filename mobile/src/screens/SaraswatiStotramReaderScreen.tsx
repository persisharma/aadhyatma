...
import { getSaraswatiStotramChapter, type SaraswatiStotramVerse } from '@/data/saraswati-stotram';
...
export default function SaraswatiStotramReaderScreen({ navigation, route }: Props) {
  ...
  const listRef = useRef<FlatList<SaraswatiStotramVerse>>(null);
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right', 'bottom']}>
        ...
        <View style={styles.listContainer}>
          <FlatList
            ...
            data={chapter.verses}
            keyExtractor={(v) => v.id}
            renderItem={({ item }) => <ShivaStrotamVersePage verse={item} sourceId="saraswati-stotram" width={width} />}
            extraData={lang}
            horizontal
            pagingEnabled
