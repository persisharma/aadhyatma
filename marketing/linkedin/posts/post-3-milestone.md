# Post 3 — Milestone: Android crossed 50+ downloads in week one  (publish ~5–7 days AFTER Post 2)
...
A small number that surprised me this week.

Vedansh — the little offline bhakti app I've been building on the side — took about 10 weeks on the App Store to reach roughly 90 downloads. Slow, steady, mostly people I know and a few who found it on their own.

I shipped the Android build last week.

It crossed 50+ downloads in seven days.

Same app. Same screens. Same zero-rupee marketing budget. Just a different door.

I don't think this says much about my app. I think it says something about where the people who actually keep these practices are. Panchang, vrat dates, a chalisa before bed, a japam count — that's not a metro-and-iPhone habit. It's a my-mother's-phone habit. And that phone runs Android.

I'd optimistically assumed my "audience" was wherever I happened to be building first. It wasn't. It was one platform away, waiting, for ten weeks.

A few things I'm taking from it:

• Distribution isn't a growth tactic you bolt on later — for some products it IS the product decision.
• "No traction" is sometimes just "wrong shelf". Before rewriting the app, check whether the people you built it for can even install it.
...
Optional
────────────────────────────────────────────────────────────
- Hashtags (pick 3–5): #BuildInPublic #IndieApp #ReactNative #Android #ProductLessons #Distribution #Bharat
