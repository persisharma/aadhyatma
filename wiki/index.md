...
## Subsystems
- [[home]] — Home (आज-first: Today strip, साधना row, eight उपकरण tiles, one पाठ door, per-user नया) and the पाठ **library** screen behind it; the three separate novelty mechanisms.
